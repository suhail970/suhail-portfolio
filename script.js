/* =====================================================
   ...
   Particle Animation, Smooth Scroll, Reveal Animations
   ===================================================== */
...
function initRevealAnimations() {
    ...
    const revealElements = document.querySelectorAll(
        '.section-header, .about-grid, .skill-card, .project-card, ' +
        '.timeline-item, .experience-card, .contact-card, .contact-cta'
    );
